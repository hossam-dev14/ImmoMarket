...
export default function Footer() {
  return (
    <footer className="bg-slate-100 text-gray-600 body-font mt-16">
      <div className="max-w-7xl mx-auto px-4 py-10 lg:px-10 flex md:items-start lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col justify-between">
        <div className="w-72 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
          ...
          >
            <div className="w-14 pr-2">
              <img className="rounded-md w-full" src={logo} alt="immomarket" />
            </div>
            <span className="text-secondary text-2xl">ImmoMarket</span>
          </Link>
          <p className="mt-2 text-sm text-gray-500">
            11910 Clyde Rapid Suite 70, Willyand, <br /> Virginia, United States
          </p>
        </div>
      ...
      <div className="bg-gray-100">
        <div className="container py-4 px-5 mx-auto flex items-center sm:flex-row flex-col">
          <p className="text-sm text-gray-500 mt-4">
            © {new Date().getFullYear()} ImmoMarket by
            <a
              href="https://hossam-dev14.github.io/"
